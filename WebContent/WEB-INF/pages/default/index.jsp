...
<title>首页 | KongYun</title>
<link href="<c:url value="/resources/css/bootstrap.min.css"/>" rel="stylesheet">
<link href="<c:url value="/resources/css/style.css"/>" rel="stylesheet">
<link rev="stylesheet" rel="stylesheet" type="text/css" href="<c:url value="/resources/css/addfeed.css"/>" media="all">
<link type="text/css" rel="stylesheet" href="<c:url value="/resources/syntaxhighlighter/styles/shCore.css"/>"/>
<link type="text/css" rel="stylesheet" href="<c:url value="/resources/syntaxhighlighter/styles/shThemeDefault.css"/>"/>
...
<link href="<c:url value="/resources/syntaxhighlighter/styles/shThemeDefault.css"/>" rel="stylesheet">
...
<body>
	<div class="container">
						...
						<div class="row">
							...
							<div class="span8" style="margin-left: 10px">
								...
								<div class="entry-meta">
									</i> <small class="muted"> 分类：<a class=""
		...
		<script type="text/javascript" src="<c:url value="/resources/syntaxhighlighter/scripts/brush.js"/>"></script>
		<script type="text/javascript">
			$(document)
					.ready(
							function() {
