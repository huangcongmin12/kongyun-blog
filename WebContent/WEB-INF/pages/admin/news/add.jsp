...
<body>
		...
		<div class="row">
			...
			<div class="span9">
				...
				<div class="succ-toggle">
					<form id="article-form"  name="article-form" action="${pageContext.request.contextPath }/admin/news/add" method="POST">

						<div class="control-group">
							<label class="control-label" for="title">标题</label> <input
								type="text" name="title" id="title" placeholder="文章标题"
								class="input-block-level"> <span id="msg-title"
								class="help-block"></span>
						</div>

						<div class="control-group">
							<label class="control-label" for="categoryId">文章分类</label> <select
								name="category.id" class="span2" id="category">
								<option value=-1>--请选择 --</option>
								<c:forEach var="category" items="${category}">
									<option value=${category.id }>${category.name }</option>
								</c:forEach>
							</select> <span id="msg-signName" class="help-block">
						</div>
						</span><br>
						<p>&nbsp;
						<div class="control-group">
							<label class="control-label" for="content">内容</label>
							<textarea id="aeditor" name="content" placeholder="你想说的东西" rows="22" class="input-block-level"></textarea>
						...
						<div class="control-group">
							...
							<textarea name="description" id="description"
								placeholder="文章简要描述" rows="3" class="input-block-level"></textarea>
							<span id="msg-description" class="help-block"></span>
						</div>

						<div class="control-group">
							<label class="control-label" for="tags">标签</label> <input
								type="text" name="tags" id="tags" placeholder="随便"
								class="input-block-level"> <span id="msg-tag"
								class="help-block"></span>
						</div>
						<div class="control-group">
							<button type="submit" id="submit"
								class="btn btn-primary pull-right">发布</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		KindEditor.ready(function(K) {
			...
			uploadJson : 'admin/FileUploadServlet',
			fileManagerJson : 'admin/FileManagerServlet',
